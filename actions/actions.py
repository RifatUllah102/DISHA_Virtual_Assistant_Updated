...
class ActionCustomFallback(Action):
    ...
    async def run(
        ...
        if tracker.get_slot("Incomplete_Story") == True:
            ...
            return[SlotSet("fallback_counter", float(fall_counter)), ActionReverted()]
...
class ActionValidationbKash(FormValidationAction):
    ...
    async def validate_account_number_confirm(
        ...
        if intent == "affirm":
            ...
            return {"account_number_confirm": None, "account_number": None, "Incomplete_Story": True, "requested_slot": "account_number"}
            # return [
            #         SlotSet("account_number_confirm", None),
            #         SlotSet("account_number", None),
            #         SlotSet("Incomplete_Story", True),
    ...
    async def validate_phone_number_confirm(
        ...
        if intent == "affirm":
            ...
            return {"phone_number_confirm": None, "phone_number": None, "Incomplete_Story": True, "requested_slot": "phone_number"}
        else:
            print("something else.")
            # dispatcher.utter_message(response = "utter_ask_continue_form")
            return [
    ...
    async def validate_amount_confirm(
        ...
        if intent == "affirm":
            ...
            return {"amount_confirm": None, "amount-of-money": None, "Incomplete_Story": True, "requested_slot": "amount-of-money"}
        else:
            print("something else.")
            # dispatcher.utter_message(response = "utter_ask_continue_form")
            return [
